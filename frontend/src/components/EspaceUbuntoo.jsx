      ...
      <header className="bg-gradient-to-br from-[#0F4C5C] to-[#0A3844] text-white pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex justify-center mb-4">
            <img 
              src="https://customer-assets.emergentagent.com/job_b883b64b-db51-4ef2-a26d-0edeb89b18e9/artifacts/lotohpwb_ChatGPT%20Image%2019%20f%C3%A9vr.%202026%2C%2017_43_21%20%281%29.png" 
              alt="Ubuntoo" 
