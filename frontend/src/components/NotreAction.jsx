...
import { Zap, Users, ArrowRight, Building, Globe, Heart, Shield, Compass, Target, Scale, Sparkles, HandHeart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50" data-testid="notre-action-page">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Introduction */}
          <div className="mb-16">
            <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-3xl p-8 md:p-12 border-l-4 border-green-500">
