...
import { Target, Heart, Users, Globe, ArrowRight, Sparkles, Shield, Brain, HandHeart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50" data-testid="notre-mission-page">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-3xl p-8 md:p-12 border-l-4 border-amber-500">
          ...
          <div className="mb-16">
            <div className="bg-gradient-to-r from-[#0b2a55] to-[#1a4280] rounded-3xl p-8 md:p-12 text-white">
