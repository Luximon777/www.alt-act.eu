    ...
    <div className="min-h-screen bg-gray-50" data-testid="notre-ambition-page">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://images.unsplash.com/photo-1662712375045-72023de1eee4?crop=entropy&cs=srgb&fm=jpg&ixlib=rb-4.1.0&q=85&w=1920&h=600&fit=crop" 
            alt="Une société plus juste" 
