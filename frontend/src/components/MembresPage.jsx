...
const COMITES = [
  {
    ...
    membres: [
      ...
      {
        nom: "Florence Scheidecker",
        fonction: "Trésorière",
        role: "Décisionnaire",
        soustitre: "Directrice Administrative et Financière — Experte en direction financière, comptabilité internationale, contrôle interne et transformation des organisations",
        photo: null,
        bio: "Florence Scheidecker est une dirigeante financière expérimentée, spécialisée dans la direction comptable et financière, le contrôle interne, le reporting international et la transformation des organisations. Membre fondatrice et Trésorière de l'Association ALT&ACT, elle contribue à la sécurisation de la gouvernance financière, à la transparence des comptes, au pilotage budgétaire et à la fiabilité des processus de gestion. Au sein de RE'ACTIF PRO, elle est positionnée comme Directrice Administrative et Financière (DAF). Son parcours de plus de trente ans dans des groupes et environnements internationaux lui confère une expertise particulièrement adaptée à la structuration financière d'un projet innovant appelé à associer financements publics et privés, R&D, partenariats institutionnels et déploiement à l'échelle européenne.",
        realisations: "Florence Scheidecker a construit une carrière de plus de trente ans dans les domaines de la comptabilité, de la finance, de l'audit et du management. Elle a notamment occupé la fonction de Director of Accounting chez CARMAT, après avoir exercé des responsabilités financières et comptables au sein de plusieurs groupes internationaux majeurs : Reporting Manager chez Cargill, French Country Controller chez Ortho Clinical Diagnostics, France Accounting Manager chez Bio-Rad Laboratories (supervision d'environ 30 collaborateurs), Finance Controller chez Euralis, et Manager of Financial Shared Service chez GlaxoSmithKline. Son parcours chez Dow Corning lui a également permis d'exercer des responsabilités financières à dimension européenne. Elle a débuté sa carrière chez BDO Gendrot, développant pendant plus de dix ans son expertise en audit et expertise comptable. Titulaire d'un French CPA, d'un Master en comptabilité, droit, finance et gestion, et d'une formation Lean Sigma – Yellow Belt.",
        vision: "Florence Scheidecker apporte à ALT&ACT et RE'ACTIF PRO une culture financière fondée sur la fiabilité des données, la maîtrise des risques, le contrôle interne et la capacité à structurer des organisations en transformation. Les valeurs qui guident son parcours — intégrité, transparence, rigueur et engagement durable — sont en résonance directe avec les principes fondateurs d'ALT&ACT : altérité, action responsable et impact sociétal. Son expertise permet notamment d'accompagner la construction et le suivi des modèles économiques et budgétaires, de renforcer la qualité du reporting destiné aux partenaires et financeurs, de sécuriser les processus comptables et financiers et d'anticiper les besoins liés à la croissance de l'organisation. Son expérience des environnements internationaux constitue également un atout pour accompagner progressivement RE'ACTIF PRO dans son changement d'échelle, depuis les premières phases de R&D et d'expérimentation jusqu'à un déploiement national puis européen.",
        signature: "Son approche associe rigueur financière, culture du contrôle, capacité de transformation et expérience du management dans des environnements internationaux complexes. Sa conviction profonde — que la fiabilité financière est un levier d'impact social — traduit un engagement éthique en phase avec la mission d'ALT&ACT : bâtir des trajectoires professionnelles sans barrières, portées par une gouvernance exemplaire. Sa maîtrise des processus comptables et financiers, du reporting, de l'audit et du contrôle interne constitue un facteur de sécurisation pour ALT&ACT et RE'ACTIF PRO. Dans les relations avec les financeurs, partenaires institutionnels et acteurs économiques, son expérience renforce la capacité des deux structures à démontrer la fiabilité de leur gouvernance, la maîtrise de leurs ressources et leur aptitude à accompagner un changement d'échelle.",
        expertise: ["Direction administrative et financière", "Pilotage budgétaire", "Reporting financier et international", "Contrôle interne et conformité", "Audit et gestion des risques", "US GAAP / IFRS", "Trésorerie et prévisions financières", "Transformation des processus financiers", "SAP et systèmes financiers", "Management d'équipes", "Lean Sigma et amélioration continue", "Structuration financière de projets"]
      }
    ]
  },
  {
    ...
    membres: [
      ...
      },
      {
        ...
        fonction: "Membre fondatrice",
        role: "Décisionnaire",
        soustitre: "Directrice Administrative et Financière",
        photo: null,
        bio: "Dirigeante financière expérimentée, spécialisée dans la direction comptable et financière, le contrôle interne et le reporting international. Les valeurs qui animent son parcours — intégrité, transparence, rigueur et engagement durable — s'inscrivent pleinement dans les fondements d'ALT&ACT : altérité, action responsable et impact sociétal. Sa vision fondée sur la fiabilité des données et l'éthique de gouvernance fait d'elle un pilier de la structuration financière de l'association.",
        expertise: ["Direction financière", "Contrôle interne", "Reporting international", "Transformation des organisations"]
      },
      {
        nom: "Anne-Marie Schwemmer",
        fonction: "Membre fondatrice",
  ...
  },
  {
    ...
    membres: [
      ...
      {
        nom: "Mounyr Bounif",
        fonction: "Directeur Stratégie & Gouvernance (CSGO) — Data, IA & transformation digitale",
        role: "Consultatif",
        soustitre: "Ancien Responsable pédagogique ICAM Strasbourg | Expert en Data & IA, conduite de projets digitaux et transformation industrielle",
        photo: null,
        bio: "Mounyr Bounif est un professionnel à double ancrage — informatique et pédagogie — dont le parcours de plus de vingt ans articule ingénierie logicielle, administration systèmes et réseaux, conduite de projets digitaux, formation d'adultes et, plus récemment, gouvernance Data et Intelligence Artificielle. Il a récemment occupé le poste de Responsable pédagogique à l'ICAM Strasbourg, où il est intervenu notamment sur les enjeux de Data & IA appliqués à la performance industrielle, avec un positionnement concret sur la gouvernance des projets, leur déploiement opérationnel et le passage de la technologie à la valeur métier. Au sein du Comité de pilotage d'ALT&ACT, il est positionné comme un profil d'interface entre technologie, Data/IA, gouvernance, formation, besoins métiers et stratégie de transformation — un rôle complémentaire à celui de Joseph Noussa, davantage orienté architecture technique et infrastructure.",
        realisations: "Mounyr Bounif a construit sa carrière à la croisée de la technologie et de l'humain. Son socle informatique repose sur un DUT Informatique – Génie logiciel (1999), un diplôme de Technicien supérieur Administration et Réseaux au CESI (2009) et un Master 2 Gestion de Projet Informatique à l'Université de Strasbourg (2011). Il a débuté comme analyste-programmeur chez FM Logistics (développement logiciel de gestion logistique, bases de données), puis formateur informatique à l'Université de Strasbourg et administrateur systèmes et réseaux. Il a ensuite exercé plusieurs fonctions de chef de projet informatique : chez Brasserie Kronenbourg (audit SI, gestion prestataires), chez Axians/Vinci Énergies (conduite de projet CRM, déploiement Microsoft Dynamics, accompagnement MOA/MOE, spécifications fonctionnelles, tests et intégration) et chez Société Générale (refonte d'outils de gestion documentaire). Chez Solerys, il a conçu et animé des ateliers d'accompagnement pour des publics en reconversion professionnelle, travaillant sur les compétences, la gestion du stress, la prise de confiance et la motivation. Plus récemment, son intervention au nom de l'ICAM Strasbourg dans le webinaire « Data & IA : du Mythe à la Performance Industrielle » confirme son évolution vers les enjeux stratégiques de la donnée et de l'intelligence artificielle.",
        vision: "Mounyr Bounif incarne la convergence entre compétence technique, gouvernance Data/IA et engagement humain que porte ALT&ACT. Pour RE'ACTIF PRO, son positionnement comme Directeur Stratégie & Gouvernance (CSGO) est particulièrement pertinent : sa capacité à faire le lien entre technologie, données, besoins métiers et stratégie de transformation constitue un levier essentiel pour structurer la dimension numérique du projet. Sa double culture — ingénierie informatique et pédagogie — lui permet de traduire les ambitions technologiques en dispositifs concrets, accessibles et alignés sur les objectifs d'impact social. Son expérience en formation et accompagnement des transitions professionnelles renforce la dimension opérationnelle de l'association dans ses programmes d'insertion et de développement des compétences.",
        signature: "Son approche se distingue par une écoute active, une rigueur méthodologique et une capacité à connecter les dimensions techniques aux enjeux humains et stratégiques. Les valeurs qui guident son parcours — transmission, accessibilité du savoir, responsabilité et impact durable — font écho aux principes fondateurs d'ALT&ACT : altérité, action et transformation positive des trajectoires professionnelles. Mounyr sait créer les conditions de la compréhension et de la progression, tant dans un cadre technique que dans l'accompagnement humain, ce qui en fait un pont naturel entre les ambitions stratégiques de l'association et leur traduction concrète.",
        formation: ["Master 2 Gestion de Projet Informatique – Université de Strasbourg", "Technicien Supérieur Administration et Réseaux – CESI", "DUT Informatique Génie Logiciel – IUT Schumann"],
        expertise: ["Data & Intelligence Artificielle", "Gouvernance de projets Data/IA", "Conduite de projets digitaux", "Transformation numérique industrielle", "Formation et pédagogie", "Accompagnement des transitions professionnelles", "Gestion de projet (CRM, SI)", "Administration systèmes et réseaux", "Conception pédagogique", "Interface technologie-métiers"]
      },
      {
        nom: "Géraldine Moser",
        fonction: "Directrice Communication, Partenariats & Rayonnement européen (CMPO)",
        role: "Consultatif",
        soustitre: "Business Development & International Marketing | Executive Education | 20+ ans d'expérience internationale dans le secteur spatial",
        photo: null,
        bio: "Géraldine Moser est une professionnelle du développement stratégique, du marketing international et de la communication institutionnelle, forte de plus de vingt ans d'expérience à l'International Space University (ISU) à Strasbourg. Son parcours se situe à l'intersection du business development, du marketing, de la communication, de l'Executive Education et de l'événementiel international. À l'ISU, elle a contribué à élargir l'offre de formation spatiale exécutive à l'échelle mondiale, identifiant les besoins de marché, développant et commercialisant des programmes, construisant des partenariats et contribuant à la croissance des revenus et de la participation. Internationale par nature, curieuse et orientée résultats, elle excelle dans la connexion entre personnes, cultures et idées, transformant des sujets complexes en messages accessibles et la communication en opportunités concrètes.",
        realisations: "Au cours de ses 20 années à l'International Space University, Géraldine Moser a connu une trajectoire ascendante remarquable : de fonctions opérationnelles (assistante du doyen, coordination logistique et marketing des programmes courts et de l'Executive MBA) jusqu'à Head of Marketing and Communications, puis Head of Business Development Unit et responsable des programmes professionnels courts, dont l'Executive Space Course. Elle a notamment porté l'ESC à un record de 42 participants, organisé des éditions hors site mémorables en Norvège, coordonné le plus grand événement TEDx de l'ISU, et développé des initiatives à l'échelle internationale (Star City, Isle of Man, envoi de CubeSats dans l'espace, liaison ISS depuis une église). Auparavant, elle a exercé pendant près de 7 ans chez Xerox au Royaume-Uni et en Suisse comme Distribution Marketing Account Manager. Elle a également suivi le Women's Leadership Program de l'ESSEC Executive Education. Bénévole de longue date à l'Union Internationale des Alsaciens à Londres, elle y a organisé des événements de collecte de fonds.",
        vision: "Géraldine Moser apporte à ALT&ACT et RE'ACTIF PRO une dimension stratégique essentielle : la visibilité, le marché, les partenariats et l'internationalisation. Sa capacité à transformer des sujets techniques complexes en messages accessibles, à construire des partenariats institutionnels, à développer des programmes et à créer des connexions entre acteurs issus de cultures et d'écosystèmes différents constitue un levier majeur pour la future stratégie européenne de RE'ACTIF PRO. Son profil complète parfaitement l'équipe de direction : Florence sécurise la dimension financière et organisationnelle, Joseph la dimension architecture et données, Mounyr l'interface informatique-gouvernance, et Géraldine porte la communication, les partenariats et le rayonnement international.",
        signature: "Les valeurs qui animent son parcours — ouverture internationale, curiosité, connexion entre les personnes et les idées, et volonté de rendre accessible ce qui est complexe — résonnent profondément avec la mission d'ALT&ACT : construire des ponts entre les trajectoires, les territoires et les opportunités. Son engagement bénévole de longue date et sa sensibilité aux dynamiques multiculturelles font d'elle une ambassadrice naturelle des valeurs d'altérité, d'action et de transformation positive portées par l'association.",
        formation: ["Women's Leadership Program – ESSEC Executive Education", "Executive Space Course – International Space University"],
        expertise: ["Business development international", "Marketing et communication institutionnelle", "Partenariats stratégiques", "Executive Education", "Événementiel international", "Relations presse", "Coordination multiculturelle", "Développement de programmes", "Rayonnement européen et international", "Transformation de la complexité en accessibilité"]
      }
    ]
  },
  {
    ...
    membres: [
      ...
      {
        nom: "Marc Avanzo",
        fonction: "Expert en leadership et facilitateur de gouvernance éthique",
        role: "Consultatif indépendant",
        ...
        vision: "Au sein du Comité de mission éthique d'ALT&ACT, Marc Avanzo apporte une expertise de haut niveau dans l'accompagnement des transformations individuelles et collectives. Sa contribution s'articule autour d'une fonction d'appui éthique : structuration d'une gouvernance consciente favorisant l'intelligence collective et la responsabilité partagée, développement du leadership interne pour les membres du bureau et responsables de projets, installation d'une culture de la consultation où les divergences deviennent productives, et accompagnement des phases de transition pour réduire les risques de fragmentation et soutenir la continuité stratégique.",
        signature: "Marc Avanzo contribue à élever le niveau de conscience organisationnelle d'ALT&ACT. Son positionnement au sein du Comité de mission éthique présente trois avantages majeurs : préserver son regard indépendant, éviter une dilution dans l'opérationnel, et mobiliser son expertise sur les moments réellement stratégiques. Sa participation favorise des pratiques décisionnelles plus matures, une meilleure prévention des tensions internes et une capacité accrue à porter un modèle éthique et innovant à l'échelle européenne.",
      ...
      {
        nom: "Aurélia Chandou",
        fonction: "Juriste en droit social & Experte Orientation, Insertion professionnelle",
        role: "Consultatif indépendant",
        soustitre: "Référente Droit du travail, Relations sociales & Éthique de l'accompagnement",
        photo: null,
        bio: "Aurélia Chandou est une juriste en droit du travail et relations sociales, doublée d'une expertise reconnue en accompagnement des transitions professionnelles, insertion et formation d'adultes. Sa formation juridique substantielle — cursus en droit mention Droit du travail (Université de Bordeaux), formation CEGOS en droit du travail et relations sociales, Master et licence en droit canonique obtenus avec mention — lui confère une lecture structurante des cadres réglementaires qui encadrent l'emploi, l'accompagnement et les pratiques professionnelles. Cette assise juridique nourrit l'ensemble de son parcours et garantit la conformité et l'éthique des dispositifs qu'elle conçoit ou évalue. Parallèlement, elle a développé une expertise opérationnelle de terrain en exerçant comme conseillère placement à France Travail à Strasbourg, consultante en développement professionnel chez AKSIS (Activ'Projet, Parcours Emploi Santé, accompagnement des licenciés économiques, bilans de compétences), consultante en orientation professionnelle chez Solerys, et intervenante sur Prépa Compétences à l'AFPA de Strasbourg. Son expérience à l'IRFAEST comme formatrice sur le titre CIP et formatrice pilote de groupes préparant le titre FPA complète cette trajectoire.",
        realisations: "Aurélia possède une formation juridique solide : cursus en droit mention Droit du travail à l'Université de Bordeaux, formation CEGOS en droit du travail et relations sociales, Master en droit canonique et licence en droit canonique obtenue avec mention à l'Université de Théologie Catholique de Strasbourg. Elle détient également le titre professionnel de Conseillère en insertion professionnelle (CIP, niveau 5), obtenu par VAE en décembre 2024, ainsi que le titre professionnel de Formatrice professionnelle d'adultes, validé en 2021. Cette double compétence — juridique et accompagnement professionnel — constitue un atout rare au sein de l'équipe.",
        vision: "Le profil d'Aurélia Chandou est particulièrement intéressant pour le Comité de mission éthique et en justice sociale car il réunit des dimensions que peu de membres possèdent simultanément : connaissance du demandeur d'emploi, pratiques d'accompagnement, fonctionnement de France Travail, ingénierie pédagogique, certification professionnelle et culture juridique. Elle intervient notamment sur la conception et l'évaluation des parcours d'accompagnement, les référentiels de compétences et savoir-être professionnels, l'éthique de l'accompagnement, la non-discrimination, la prise en compte des publics vulnérables ou éloignés de l'emploi, la conformité des pratiques avec le cadre de l'emploi et du travail, ainsi que sur la pertinence « terrain » des recommandations produites par l'IA.",
        signature: "Son positionnement sur le pôle scientifique, éthique et méthodologique apporte une voix essentielle : celle du terrain. Sa connaissance directe des dispositifs publics d'emploi, des réalités des demandeurs d'emploi et des exigences de certification professionnelle garantit que les ambitions d'ALT&ACT et de RE'ACTIF PRO restent ancrées dans la réalité des parcours et des pratiques. Les valeurs qui guident son engagement — justice sociale, non-discrimination, éthique de l'accompagnement et accessibilité — sont au cœur même de la mission d'ALT&ACT.",
        formation: ["Titre professionnel CIP (niveau 5) – VAE, AFPA, 2024", "Titre professionnel Formatrice professionnelle d'adultes – AFPA, 2021", "Master en Droit canonique – Université de Théologie Catholique de Strasbourg", "Licence en Droit canonique (mention) – Université de Théologie Catholique de Strasbourg", "Formation Droit du travail et relations sociales – CEGOS"],
        expertise: ["Droit du travail et relations sociales", "Conformité réglementaire de l'emploi", "Éthique de l'accompagnement", "Non-discrimination", "Orientation et transitions professionnelles", "Insertion professionnelle", "Accompagnement des demandeurs d'emploi", "France Travail et dispositifs emploi", "Formation professionnelle d'adultes", "Ingénierie pédagogique", "Bilan de compétences", "Évaluation et certification des compétences"]
      }
    ]
  }
];
