...
const COMITES = [
  ...
  },
  {
    ...
    membres: [
      ...
      {
        nom: "Mounyr Bounif",
        fonction: "Formation, accompagnement & transformation digitale",
        role: "Consultatif",
        soustitre: "Consultant formateur & animateur | Expert en conduite de projets digitaux et accompagnement des transitions professionnelles",
        photo: null,
        bio: "Mounyr Bounif est un consultant formateur et animateur expérimenté, spécialisé dans l'accompagnement des transitions professionnelles, la formation d'adultes et la conduite de projets digitaux. Fort d'un parcours de plus de vingt ans croisant ingénierie informatique, gestion de projet et pédagogie, il allie une expertise technique solide à une sensibilité humaine affirmée. Au sein du Comité de pilotage d'ALT&ACT, il apporte une capacité unique à concevoir et animer des dispositifs d'accompagnement centrés sur la valorisation des compétences, la reprise de confiance et la mobilisation des talents — des enjeux au cœur de la mission de l'association.",
        realisations: "Mounyr Bounif a construit une carrière riche à la croisée de la technologie et de l'humain. Chez Solerys, il a conçu et animé des ateliers d'accompagnement pour des publics en reconversion professionnelle, en introspection et en bilan de compétences, travaillant sur les thématiques de valeurs, compétences, gestion du stress, prise de parole, développement du réseau et motivation. En tant qu'entrepreneur, il a piloté des projets de création web, SEO et formation d'adultes. Il a été chef de projet chez Société Générale (refonte d'outils documentaires), chez Axians/Vinci Énergies (déploiement CRM Microsoft Dynamics) et chez Brasserie Kronenbourg (audit SI). Son parcours inclut également l'administration systèmes et réseaux, l'enseignement universitaire à Strasbourg et le développement logiciel chez FM Logistics. Titulaire d'un Master 2 en Gestion de Projet Informatique (Université de Strasbourg) et d'un DUT Informatique.",
        vision: "Mounyr Bounif incarne la convergence entre compétence technique et engagement humain que porte ALT&ACT. Son expertise en accompagnement des transitions professionnelles — de la conception pédagogique à l'animation de groupe — constitue un levier stratégique pour RE'ACTIF PRO. Sa capacité à former, à transmettre et à créer des environnements d'apprentissage bienveillants renforce la dimension opérationnelle de l'association dans ses programmes d'insertion et de développement des compétences. Son expérience de la conduite de projets digitaux apporte également une valeur ajoutée pour la transformation numérique des dispositifs d'accompagnement.",
        signature: "Son approche se distingue par une écoute active, une empathie naturelle et une rigueur méthodologique qui font écho aux valeurs fondatrices d'ALT&ACT : altérité, action, responsabilité et impact durable. Mounyr sait créer les conditions de la confiance et de la progression, tant dans un cadre technique que dans l'accompagnement humain. Sa double culture — ingénierie et pédagogie — en fait un pont entre les ambitions stratégiques de l'association et leur traduction concrète auprès des bénéficiaires.",
        ...
        expertise: ["Formation et animation d'adultes", "Accompagnement des transitions professionnelles", "Conduite de projets digitaux", "Conception pédagogique", "Gestion de projet (CRM, SI)", "Administration systèmes et réseaux", "Création web et SEO", "Écoute active et empathie", "Développement des compétences", "Bilan de compétences et reconversion"]
      }
    ]
  },
  {
