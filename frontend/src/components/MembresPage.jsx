...
const COMITES = [
  ...
  },
  {
    ...
    membres: [
      ...
      {
        nom: "Aurélia Chandou",
        fonction: "Experte Orientation, Insertion professionnelle & Formation",
        role: "Consultatif indépendant",
        soustitre: "Référente Droit social, Parcours & Éthique de l'accompagnement",
        photo: null,
        bio: "Aurélia Chandou est une professionnelle de l'accompagnement des transitions professionnelles, de l'insertion et de la formation d'adultes. Son parcours s'est progressivement spécialisé dans l'orientation, les dispositifs d'emploi et l'ingénierie pédagogique, avec une connaissance directe de plusieurs environnements de l'écosystème de l'emploi que RE'ACTIF PRO cherche à faire évoluer. Elle a notamment exercé comme conseillère placement à France Travail à Strasbourg, puis consultante en développement professionnel chez AKSIS (Activ'Projet, Parcours Emploi Santé, accompagnement des licenciés économiques, bilans de compétences) et consultante en orientation professionnelle chez Solerys. À l'AFPA de Strasbourg, elle est intervenue sur Prépa Compétences. Son expérience à l'IRFAEST complète cette trajectoire : formatrice sur le titre CIP et formatrice pilote de groupes préparant le titre FPA, avec suivi pédagogique, évaluations en cours de formation et préparation à la certification.",
        realisations: "Aurélia possède le titre professionnel de Conseillère en insertion professionnelle (CIP, niveau 5), obtenu par VAE en décembre 2024, ainsi que le titre professionnel de Formatrice professionnelle d'adultes, validé en 2021. Son parcours académique comprend également un Master en droit canonique et une licence en droit canonique obtenue avec mention (Université de Théologie Catholique de Strasbourg), un cursus en droit avec mention Droit du travail (Université de Bordeaux), ainsi qu'une formation CEGOS en droit du travail et relations sociales. Cette double compétence — accompagnement professionnel et culture juridique — constitue un atout rare au sein de l'équipe.",
        ...
        expertise: ["Orientation et transitions professionnelles", "Insertion professionnelle", "Accompagnement des demandeurs d'emploi", "France Travail et dispositifs emploi", "Formation professionnelle d'adultes", "Ingénierie pédagogique", "Bilan de compétences", "Droit du travail et relations sociales", "Éthique de l'accompagnement", "Non-discrimination", "Évaluation et certification des compétences", "Reconversion professionnelle"]
      }
    ]
  }
];
