      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/95 backdrop-blur-lg shadow-lg' : 'bg-transparent'}`} data-testid="navigation">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <a href="/" onClick={(e) => goToPage(e, '/')} className="flex flex-col items-start group mt-3" data-testid="logo-link">
              ...
              <img 
                ...
                className="h-auto mt-3 rounded-sm opacity-90 hover:opacity-100 transition-opacity"
                style={{width: '100px'}}
