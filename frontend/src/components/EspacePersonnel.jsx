    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="bg-gradient-to-r from-orange-500 to-amber-500 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-orange-100 mb-8 max-w-2xl mx-auto">Contactez-nous en toute confidentialité. Accordez vous un premier échange pour comprendre votre situation et vous orienter.</p>
