...
function MotPresident() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['intro', 'tensions', 'technologie', 'question', 'naissance', 'conviction', 'discrimination', 'contribution', 'ambition'];
  ...
  const memoItems = [
    { id: 'intro', icon: AlertTriangle, title: 'Le constat', summary: 'La fin des réponses d\'hier', color: 'bg-gray-600' },
    { id: 'tensions', icon: Users, title: 'Les tensions', summary: 'Services publics et professionnels sous pression', color: 'bg-red-500' },
    { id: 'technologie', icon: Cpu, title: 'L\'essor technologique', summary: 'IA et risque d\'exclusion', color: 'bg-purple-500' },
    { id: 'question', icon: HelpCircle, title: 'La question centrale', summary: 'Quel monde pour demain ?', color: 'bg-amber-500' },
    { id: 'naissance', icon: Sparkles, title: 'Naissance d\'ALT&ACT', summary: 'Une réponse à cette réalité', color: 'bg-[#0b2a55]' },
    { id: 'conviction', icon: Heart, title: 'Notre conviction', summary: 'Révéler les capacités de chacun', color: 'bg-rose-500' },
    { id: 'discrimination', icon: Target, title: 'Équité et inclusion', summary: 'Combattre les discriminations', color: 'bg-teal-500' },
    { id: 'contribution', icon: TrendingUp, title: 'De l\'assistance à la contribution', summary: 'Un changement de paradigme', color: 'bg-orange-500' },
  ];
            ...
            <div className="sticky top-24">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-[#0b2a55] to-[#1a4280] px-5 py-4">
                  ...
                  <p className="text-blue-200 text-sm mt-1">Les idées clés du fondateur</p>
                </div>
                ...
                <div className="px-5 pb-5">
                  <div className="bg-gradient-to-br from-[#0b2a55]/10 to-[#1a4280]/5 rounded-xl p-4 border border-[#0b2a55]/20">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#0b2a55] rounded-full flex items-center justify-center text-white text-sm font-bold">
                        CL
                      </div>
                      <div>
                        <p className="text-sm font-semibold text-[#0b2a55]">Chitrasen Luximon</p>
                        <p className="text-xs text-gray-500">Fondateur d&apos;ALT&amp;ACT</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <main className="flex-1 min-w-0">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-8 md:p-12 space-y-6">
                ...
                {/* De l'assistance à la contribution */}
