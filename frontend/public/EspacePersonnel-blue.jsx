...
import { ArrowLeft, User, Shield, Heart, Compass, Scale, Brain, CheckCircle, Sparkles, MessageCircle } from 'lucide-react';
      ...
      <section className="bg-gradient-to-r from-[#0b2a55] to-[#1a4280] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={handleBackHome} className="bg-white text-[#0b2a55] hover:bg-blue-50 px-8 py-6 text-lg"><MessageCircle className="w-5 h-5 mr-2" />Nous contacter</Button>
